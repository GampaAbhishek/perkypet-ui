...
import "./Footer.css";
import AdverticeImage from '../../assets/advertiseimage.png'
      ...
      <div className="footer-advertisement">
        <div className="app-download-section">
          <div className="app-download-content">
            ...
            <p>
              Get the app on your iPhone or Android and track your pet's health
              for a better you.
            </p>
          ...
          <div className="app-mockup">
            <img src={AdverticeImage} alt="PerkyPet App" />
          </div>
        </div>
      </div>
